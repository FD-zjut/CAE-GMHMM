...
class KDD99Loader(object):
    def __init__(self, data_path, mode="train"):
        ...
        data_pin_abnormal_25t = np.loadtxt('D:/数据_刘嘉帅/combined_data_abnormal_aegmhmm_0.25t.txt', dtype=str, delimiter=',')
        data_pin_abnormal_sin = np.loadtxt('D:/数据_刘嘉帅/combined_data_abnormal_aegmhmm_sin.txt', dtype=str, delimiter=',')
        data_pin_abnormal_zhengtai = np.loadtxt('D:/数据_刘嘉帅/combined_data_abnormal_aegmhmm_zhengtai.txt', dtype=str, delimiter=',')
