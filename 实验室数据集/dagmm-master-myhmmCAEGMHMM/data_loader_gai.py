...
class KDD99Loader(object):
    def __init__(self, data_path, mode="train"):
        ...
        data_pin_abnormal_DDA_t1200 = np.loadtxt('D:/数据_刘嘉帅/24.5.18敏感性/combined_data_abnormal_t1200.txt', dtype=str,delimiter=',')
        ...
        # file_paths = [r'D:\数据_刘嘉帅\r=9 无故障\data.txt', r'D:\数据_刘嘉帅\r=9.5 无故障\data.txt', r'D:\数据_刘嘉帅\r=10 无故障\data.txt']
        # chunk_size = 1600
        # desired_length = 360000
        # output_file = r'D:\数据_刘嘉帅\combined_data.txt'
        #
        # combined_data = combine_files_chunk(file_paths, chunk_size, desired_length)
