...
test_z = np.loadtxt('D:/cw/dagmm-master-myhmm1221multi_cond - 副本_plot/test_z.txt', dtype=str, delimiter=' ').astype('float32')
row_to_delete = np.concatenate([np.arange(600,900),np.arange(1100,1400),np.arange(1500,1800)])
# row_to_delete = np.concatenate([np.arange(300,600),np.arange(800,900),np.arange(1000,1080)])
