...
# output_file = r'D:\数据_刘嘉帅\combined_data_abnormal_caehmm_0.993.txt'
# output_file = r'D:\数据_刘嘉帅\combined_data_abnormal_caehmm_0.25t.txt'
output_file = r'D:\数据_刘嘉帅\combined_data_abnormal_caehmm_sin.txt'
# output_file = r'D:\数据_刘嘉帅\combined_data_abnormal_caehmm_zhengtai.txt'
