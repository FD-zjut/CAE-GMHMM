...
if __name__ == '__main__':
    ...
    parser.add_argument('--latent_dim', type=int, default=13)  # 3 应该是大于等于7 13
    parser.add_argument('--num_states', type=int, default=3)  # 3

    parser.add_argument('--lambda_energy', type=float, default=0.01)#0.1
    parser.add_argument('--lambda_cov_diag', type=float, default=1e-8)#0.005
