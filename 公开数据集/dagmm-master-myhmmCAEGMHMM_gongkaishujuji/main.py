...
if __name__ == '__main__':
    ...
    # Training settings
    parser.add_argument('--num_epochs', type=int, default=30)#200
    parser.add_argument('--batch_size', type=int, default=5)#1024
    parser.add_argument('--gmm_k', type=int, default=5) #4
    parser.add_argument('--latent_dim', type=int, default=7)  # 3 应该是大于等于13
    parser.add_argument('--num_states', type=int, default=12)  # 12

    parser.add_argument('--lambda_energy', type=float, default=0.00000001)#0.1
