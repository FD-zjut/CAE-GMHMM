...
matrix_addfault1 = np.reshape(matrix_addfault, (slid_window, _all_length_abnormal*4  // slid_window, -1))
...
selftest_labels = test_labels
# self.test = self.test.reshape(-1, 9, 16)
X_train = np.reshape(selftrain, (-1, 3200))#1200
X_test = np.reshape(selftest, (-1, 3200))
