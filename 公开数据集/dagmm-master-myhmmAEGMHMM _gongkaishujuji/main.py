...
if __name__ == '__main__':
    ...
    parser.add_argument('--latent_dim', type=int, default=5)  # 3 应该是大于等于7
    parser.add_argument('--num_states', type=int, default=4)  # 3 #3效果很差，4就很好了

    parser.add_argument('--lambda_energy', type=float, default=0.0000001)#0.1
